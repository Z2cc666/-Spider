...
class ChinaYouthDailyIncrementalSpider:
    def __init__(self):
        self.headers = {
        ...
        # 记录文件
        self.record_file = "中国青年报_crawled_articles.json"
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('中国青年报_crawler.log', encoding='utf-8'),
...
def run_spider():
    """运行爬虫的定时任务"""
    spider = ChinaYouthDailyIncrementalSpider()
    spider.crawl_today()
...
if __name__ == '__main__':
    ...
    if TEST_MODE:
        print("=== 测试模式 ===")
        # 使用固定的测试日期
        test_date = '2025-07-04'  # 使用一个确定存在的日期
