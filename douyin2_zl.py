...
class DouyinVideoDownloader:
    ...
    def get_user_videos(self, sec_uid: str, max_count: int = 100) -> List[Dict]:
        """获取用户视频列表 - 带分页功能"""
    ...
    def download_user_videos(self, sec_uid: str, max_count: int = 100):
        """下载用户所有视频"""
...
if __name__ == "__main__":
    ...
    # 下载前5个视频
    downloader.download_user_videos(sec_uid, max_count=100)